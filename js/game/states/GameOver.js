export default class GameOver extends Phaser.State {
	preload() {
		...
		this.load.image('buttonBack', 'public/assets/button_back.png')
	...
	create() {
		...
		this.button = this.add.button(this.world.width-50, 50, 'buttonBack', this.actionOnClick, this, 2, 1, 0);
		this.button.anchor = new Phaser.Point(1, 0);
